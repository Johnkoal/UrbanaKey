...
{
    /// <inheritdoc />
    public partial class AddFinanceAndAssemblyRefinements : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommonAreaId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PqrComments", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
        }
